        ...
        <form className='space-y-6' onSubmit={handleSubmit} >
          {!isLogin && (
            <div>
              <label
                htmlFor="full-name"
                className='block text-[11px] font-semibold text-zinc-400 uppercase tracking-wideest mb-2'
              >
                Full Name
              </label>
              <input
                ...
                required
                className='w-full pl-2 py-2 border-b border-zinc-200
          ...
          <div>
            ...
            <div className='relative'>
              ...
              >
                {showPassword ? <EyeOffIcon size={14} /> : <Eye size={14} />}
              </button>
            </div>
          </div>
        </form>
