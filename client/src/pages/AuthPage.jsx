...
import { Eye, EyeIcon, EyeOffIcon, Loader2Icon } from 'lucide-react';
    ...
    <div className = "min-h-screen bg-white flex text-zinc-900 font-sans">
      ...
      <div className='flex-1 flex items-center justify-center p-8'>
          ...
          <div className='mb-10'>
            ...
            text-zinc-900 mb-1.5 font-sans'>
              ...
              <p className='text-sm text-zinc-400'>
                {isLogin ? "Enter your credentials to access your website builder." : "Create an account"}
              </p>
          </div>
        ...
        <form className='space-y-6' onSubmit={handleSubmit} >
          {!isLogin && (
            <div>
              <label className='block text-[11px] font-semibold text-zinc-400 uppercase tracking-wideest mb-2'>
                Full Name
              </label>
              <input type="text" value = {name}
               ...
               bg-transparent placeholder-zinc-300 transition-colors' placeholder='John Smith'/>
            </div>
          )}
          <div>
              <label className='block text-[11px] font-semibold text-zinc-400 uppercase tracking-wideest mb-2'>
            ...
            <div>
              ...
              <div className='relative'>
               ...
               required className='w-full pl-2 py-2 border-b border-zinc-200
               focus:outline-none focus:border-zinc-950 text-sm text-zinc-900
               bg-transparent placeholder-zinc-300 pr-8 ' placeholder='••••••••'/>
                <button type = "button" onClick={()=>setShowPassword(!showPassword)} 
                className='absolute right-2 top-1/2 -translate-y-1/2 text-zinc-300
                cursor-pointer transition-colors'>{showPassword ? <EyeOffIcon size = {14}/> : <Eye size = {14}/>}</button>
              </div>
            ...
            transition-all'>{loading && <Loader2Icon className='animate-spin h-3.5 w-3.5 mr-2' />}
