...
import { ArrowRightIcon, ClockIcon, TrashIcon, SparklesIcon, FolderCodeIcon, LogOutIcon, UserIcon } from 'lucide-react'
...
const HomePage = () => {
  ...
  return (
    <div className="h-screen overflow-y-auto text-zinc-100 font-sans bg-zinc-950 relative transition-colors duration-200">
      ...
      {/* Hero Section */}
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pb-20 mt-8 xl:mt-20">
        <div className="w-full max-w-2xl flex flex-col items-center">
          
          {/* Promo Badge */}
          <div className="inline-flex items-center gap-2 p-1 pr-3.5 bg-white/5 backdrop-blur-xl rounded-full border border-white/15 text-xs text-zinc-300 shadow-xl mb-6">
          ...
          {/* Title & Description */}
          <h1 className="text-center text-4xl md:text-6xl font-bold tracking-tight text-white leading-tight">
