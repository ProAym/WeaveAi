  ...
  return (
    <div className='flex flex-col h-full bg-white'>
        ...
        hide-scrollbar'>
            ...
            {loading && (
                <div className='flex gap-2.5 item-start'>
                    <div className='shrink-0 w-6 h-6 rounded-md flex items-center
                    justify-center my-0.5 bg-zinc-900/5'>
                        <BotIcon size={13} className='text-zinc-900'/>
                    </div>
                    <div className='flex-1'>
                        <p className='text-[11px] font-medium text-zinc-400 mb-2 uppercae tracking-wider'>AI</p>
