...
export async function createProject(req, res){
    ...
    //Create project in dp immediately with pending status
...
//List all projects owne by the user (summary only , no file contents)
...
//Update projects files(manual edits)
...
//mark project as publicly published
...
//Get a publicly published project details(wıthout auth)
